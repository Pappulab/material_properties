...
The `source_data` folder contains all experimental and computational data for the final figures. For more information, please see the comments in the .m files in the `codes` folder.
