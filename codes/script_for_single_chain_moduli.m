...
% Can also weight by relative energies (weighting doesn't really do anything anyway)

RelEl = zeros(Res,Res);

% These energies are specific to the A1-LCD system (Farag et al., Nature
% Communications 2022, and are needed for weighting the sub-graphs. Make
% this an upper triangular array:
