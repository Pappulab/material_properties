...
% Uses overall graph with adjacencies defined by stickers only

% To run, this program needs generate_sticker_site_graph.m,
...
writetable(cell2table(C_aug),'moduli_single_chain_A.csv','WriteVariableNames',0)
...
writetable(cell2table(C_aug),'times_single_chain_A.csv','WriteVariableNames',0)
